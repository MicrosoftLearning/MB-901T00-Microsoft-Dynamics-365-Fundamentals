...
## Practice Lab - Validate Customer Engagement lab environment 

Scenario
--------

In this Module 0 lab, you will validate that your Customer Engagement classroom tenant is working as expected. You will access your individual credentials, record your “alias”, and open the Dynamics 365 model-driven application that we will be using throughout the course. 
